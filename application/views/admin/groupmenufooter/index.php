<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=base_url();?>admin/groupmenufooter">
                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                               ...
                               <td class="right"><a href="#">Vị trí</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left"><?=$user['link'];?></td>
                                 <td class="right"><? if($user['active']==1) { echo "Hiển thị"; } else { echo "Không"; } ?></td>
