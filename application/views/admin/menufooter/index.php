<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=base_url();?>admin/menufooter">
                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                                ...
                                <td class="left"><a href="#">Link</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    ...
                                    {
                                        	$sql="select * from group_menufooter where id=\"".$user['parent']."\"";	
                                             $namemenu= $this->db->query($sql);
                                             $kqnamemenu=$namemenu->row();
                                             echo $kqnamemenu->name;
                                    }
       
                                    ?></td>
                                
                                 <td class="right"><?=$user['link'];?></td>
