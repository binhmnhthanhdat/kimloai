                ...
                <div id="tab_1" style="display:block;">
                    <table width="100%" class="form">
                        <tbody>
                            ...
                            <tr>                                  
                                <td width="169" align="left"><label>Giá sản phẩm:</label></td>  
                                <td width="922">                                    	
                                    <?php if (@$q->gia != '') : ?>                   
                                    <input name="gia" type="text" id="gia" value="<?php echo @$q->gia; ?>" size="100" />  
                                      <?php else : ?>                                     
                                    <input name="gia" type="text" id="gia" value="<?php echo set_value('gia'); ?>" size="100" />  
                                      <?php endif; ?>                                    	
                                      <?= form_error('gia'); ?>                   
                                </td>                                
                            </tr>
                            <tr>
                                <td align="left"><label>Nổi bật:</label><br /><span class="help">Sản phẩm này là nổi bật</span></td>
                                <td>
                                    <input type="checkbox" name="noibat" <?php if (@$q->noibat == 1) echo "checked=checked";
                                    else ""; ?>/>

                                </td>
                            </tr>
                            <tr>
                                <td align="left"><label>Khuyến mại:</label><br /><span class="help">Sản phầm này là khuyến mại</span></td>
                                <td>
                                    <input type="checkbox" name="khuyenmai" <?php if (@$q->khuyenmai == 1) echo "checked=checked";
                                    else ""; ?>/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="status" <?php if (@$q->status == 1) echo "checked=checked";
                                    else ""; ?>/>
