                ...
                <form action="<?=$action;?>" method="post" enctype="multipart/form-data" id="frm_add">
               	  <div id="tab_1" style="display:block;">
						...
						<tbody>
                                ...
                                </tr>								<tr>                                  <td width="169" align="left"><label>Giá sản phẩm:</label></td>                                    <td width="922">                                    	<?php if(@$q->gia !='') :?>                                        <input name="gia" type="text" id="gia" value="<?php echo @$q->gia;?>" size="100" />                                        <?php else : ?>                                        <input name="gia" type="text" id="gia" value="<?php echo set_value('gia');?>" size="100" />                                        <?php endif;?>                                    	<?=form_error('gia');?>                                	</td>                                </tr>
                                <tr>
