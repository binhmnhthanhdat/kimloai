<script type="text/javascript">
	...
	function do_search() {
		...
		var url = index_url + 'admin/service/';
...
<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=$this->index_url;?>admin/service">
       	  ...
       	  <thead>
                        	<tr>
                              ...
                              <td width="419" class="left"><a href="#">Tên dịch vụ</a></td>
                        ...
                        <tbody>
                        	<tr class="filter">
                                ...
                                <td class="right"><a class="button" onclick="do_search();">Lọc dịch vụ</a></td>
                            </tr>
