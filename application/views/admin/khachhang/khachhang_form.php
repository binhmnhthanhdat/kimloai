        ...
        <div class="box">
        	<div class="heading">
                ...
                <div class="buttons">
                    ...
                    <a href="javascript:void(0);" onclick="location.href='<?=base_url();?>admin/khachhang';" class="button">Cancel</a>
                </div>
            </div><!--End heading-->
            <div class="content">
            	<div id="tabs" class="htabs">
                	<a href="#tab_1" class="selected">Thông tin Khách hàng</a>
                ...
                <form action="<?=$action;?>" method="post" enctype="multipart/form-data" id="frm_add">
               	  <div id="tab_1" style="display:block;">
						...
						<tbody>
                           	  <tr>
                                  <td width="169" align="left"><label>Tên Khách hàng</label></td>
                                    <td width="922">
                                    	<?php if(@$article->name !='') :?>
