<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=base_url();?>admin/hotro">
                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                                ...
                                <td class="left"><a href="#">Tên </a></td>
								<td class="left"><a href="#">Loại liên lạc ( Yahoo, Skype, Phone)</a></td>
								<td class="left"><a href="#">Thông tin( Tên Yahoo, Tên Skype, Số Phone)</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left"><?=$user['name'];?></td>
								  ...
								  <td class="left"><? if($user['used']==1) { echo "Hỗ trợ bằng yahoo"; } else  if($user['used']==2) { echo "Hỗ trợ bằng Skype"; } else if($user['used']==3) { echo "Hỗ trợ bằng Phone"; } ?></td>
                                  <td class="left"><? echo $user['info'];?></td>
								  <td class="left"><? echo $user['ord'];?></td>
                                 <td class="right">
                                	<?if($user['active']==1)
                                		echo "Hiển thị";
                                	else
