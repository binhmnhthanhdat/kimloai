        ...
        <div class="box">
        	<div class="heading">
                ...
                <div class="buttons">
                    ...
                    <a href="javascript:void(0);" onclick="location.href='<? echo base_url();?>admin/hotro';" class="button">Cancel</a>
                </div>
            </div><!--End heading-->
            <div class="content">
            	<div id="tabs" class="htabs">
                	<a href="#tab_1" class="selected">Thông tin Hỗ trợ</a>
                ...
                <form action="<?=$action;?>" method="post" enctype="multipart/form-data" id="frm_add">
               	  <div id="tab_1" style="display:block;">
						...
						<tbody>
                                ...
                                <tr>
                                 <td width="169" align="left"><label>Loại liên lạc ( Yahoo, Skype, Phone) :</label></td>
                                    <td width="922">
                                        <select name="used">
												<option value="1" <?php if(@$article->used == 1) echo "selected";?>>Hỗ trợ bằng Yahoo</option>
                                                <option value="2" <?php if(@$article->used == 2) echo "selected";?>>Hỗ trợ bằng Skype</option>
												<option value="3" <?php if(@$article->used == 3) echo "selected";?>>Hỗ trợ bằng Phone</option>
                                        </select>
                                        <?=form_error('used');?>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                  <td width="169" align="left"><label>Thông tin( Tên Yahoo, Tên Skype, Số Phone):</label></td>
                                    <td width="922">
                                        <?php if(@$article->info !='') :?>
                                        <input name="info" type="text" id="info" value="<?php echo @$article->info;?>" size="100" />
                                        <?php else : ?>
                                        <input name="info" type="text" id="info" value="<?php echo set_value('info');?>" size="100" />
                                        <?php endif;?>
                                        <?=form_error('info');?>
                                    </td>
                                </tr>
