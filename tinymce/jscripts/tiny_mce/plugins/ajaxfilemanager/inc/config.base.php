...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_UPLOAD_MAXSIZE', 5000 * 10240 ); //by bytes
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,zip,rar,gz,tar,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,flv,ppt,rtf,doc,pdf,txt');// // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,flv');
